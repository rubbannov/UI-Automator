...
//    }
    ...
    @Test
    fun testEnterSpaseSymbols() {
        val packageName = MODEL_PACKAGE
        waitForPackage(packageName)
        //recording original text
        ...
        device.findObject(By.res(packageName, "buttonChange")).click()
        //recording changes
        val afterChangeText = device.findObject(By.res(packageName, "textToBeChanged")).text

        assertEquals(originalText, afterChangeText)
    }
